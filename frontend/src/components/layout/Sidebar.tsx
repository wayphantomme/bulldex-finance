...
// Grouped nav — matches Jupiter's "Trade / Earn / Manage" pattern
...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-14 bottom-0 z-40 flex w-16 flex-col items-center border-r border-base-border bg-base-surface pt-4 pb-4 gap-0">

      {NAV_GROUPS.map((group, gi) => (
        <div key={group.label} className={cn('flex w-full flex-col items-center gap-0.5', gi > 0 && 'mt-3')}>

          {/* Section label — only visible as tooltip context, hidden at w-16 */}
